...
const subcategories = [
  // Guitars
  {
    ...
    image: `https://res.cloudinary.com/drbhtzgcs/image/upload/${IMAGE_RESIZE_OPTIONS}/v1782414845/jeremy-allouche-YStboKiFPVw-unsplash_1_hdrwki.jpg`,
  ...
  },
  {
    ...
    slug: "bass-guitars",
    parentCategorySlug: "guitars",
    image: `https://res.cloudinary.com/drbhtzgcs/image/upload/${IMAGE_RESIZE_OPTIONS}/v1782414710/bass-guitars_ci1qh6.jpg`,
  ...
  },
  {
    ...
    parentCategorySlug: "guitars",
    image: `https://res.cloudinary.com/drbhtzgcs/image/upload/${IMAGE_RESIZE_OPTIONS}/v1782414713/acoustic-guitars_grpuai.jpg`,
    description: "Acoustic guitars",
    isActive: true,
  },
  {
    name: "Clasical Guitars",
    slug: "clasical-guitars",
    parentCategorySlug: "guitars",
    image: `https://res.cloudinary.com/drbhtzgcs/image/upload/${IMAGE_RESIZE_OPTIONS}/v1782425307/alvison-lucas-hunter-arnuero-Xy-R2WRwzPY-unsplash_yie5mc.jpg`,
    description: "Clasical guitars",
    isActive: true,
  },
  ...
  // Amplification
  {
    ...
    image: `https://res.cloudinary.com/drbhtzgcs/image/upload/${IMAGE_RESIZE_OPTIONS}/v1782414717/amp-heads_wfcvvv.jpg`,
  ...
  },
  {
    ...
    slug: "combo-amps",
    parentCategorySlug: "amplification",
    image: `https://res.cloudinary.com/drbhtzgcs/image/upload/${IMAGE_RESIZE_OPTIONS}/v1782414720/combo-amps_vkzqwt.jpg`,
  ...
  },
  {
    ...
    slug: "cabinets",
    parentCategorySlug: "amplification",
    image: `https://res.cloudinary.com/drbhtzgcs/image/upload/${IMAGE_RESIZE_OPTIONS}/v1782414719/cabinets_pzbpvz.jpg`,
  ...
  },
  {
    ...
    slug: "bass-amps",
    parentCategorySlug: "amplification",
    image: `https://res.cloudinary.com/drbhtzgcs/image/upload/${IMAGE_RESIZE_OPTIONS}/v1782414715/bass-amps_wavott.jpg`,
  ...
  // Effects
  {
    ...
    image: `https://res.cloudinary.com/drbhtzgcs/image/upload/${IMAGE_RESIZE_OPTIONS}/v1782414718/overdrive-distortion_rixq3p.jpg`,
  ...
  },
  {
    ...
    slug: "delay",
    parentCategorySlug: "effects",
    image: `https://res.cloudinary.com/drbhtzgcs/image/upload/${IMAGE_RESIZE_OPTIONS}/v1782414710/delay_xqfu0w.jpg`,
  ...
  },
  {
    ...
    slug: "reverb",
    parentCategorySlug: "effects",
    image: `https://res.cloudinary.com/drbhtzgcs/image/upload/${IMAGE_RESIZE_OPTIONS}/v1782414709/reverb_ovugce.jpg`,
  ...
  },
  {
    ...
    slug: "wah",
    parentCategorySlug: "effects",
    image: `https://res.cloudinary.com/drbhtzgcs/image/upload/${IMAGE_RESIZE_OPTIONS}/v1782425410/marco-ibanez-7DBzdRsH-zM-unsplash_p3tdjg.jpg`,
    description: "Kirk Hammet's love wah-wah pedals",
    isActive: true,
  },
  {
    name: "Modulation",
    slug: "modulation",
    parentCategorySlug: "effects",
    image: `https://res.cloudinary.com/drbhtzgcs/image/upload/${IMAGE_RESIZE_OPTIONS}/v1782414712/modulation_swuotm.jpg`,
  ...
  },
  {
    ...
    slug: "multi-effects",
    parentCategorySlug: "effects",
    image: `https://res.cloudinary.com/drbhtzgcs/image/upload/${IMAGE_RESIZE_OPTIONS}/v1782414709/multi-effects_gkpezs.jpg`,
  ...
  // Recording
  {
    ...
    image: `https://res.cloudinary.com/drbhtzgcs/image/upload/${IMAGE_RESIZE_OPTIONS}/v1782414710/audio-interfaces_d7d2zl.jpg`,
  ...
  },
  {
    ...
    parentCategorySlug: "recording",
    image: `https://res.cloudinary.com/drbhtzgcs/image/upload/${IMAGE_RESIZE_OPTIONS}/v1782414711/studio-headphones_g1bndr.jpg`,
  ...
  },
  {
    ...
    parentCategorySlug: "recording",
    image: `https://res.cloudinary.com/drbhtzgcs/image/upload/${IMAGE_RESIZE_OPTIONS}/v1782425997/scott-major-ZP2iqHtUtyc-unsplash_vhffyd.jpg`,
    description: "All variety of studio monitors",
    isActive: true,
  },
  {
    name: "Microphones",
    slug: "microphones",
    parentCategorySlug: "recording",
    image: `https://res.cloudinary.com/drbhtzgcs/image/upload/${IMAGE_RESIZE_OPTIONS}/v1782414718/microphones_clnlxx.jpg`,
